// Command fleetify-agent is the Fleeto agent: one static binary that installs itself, enrolls, and runs as a service.
package main
...
func cmdVersion(stdout io.Writer) int {
	fmt.Fprintf(stdout, "fleetify-agent %s (%s/%s)\n", version.Version, runtime.GOOS, runtime.GOARCH)
