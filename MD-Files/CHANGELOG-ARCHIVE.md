...
Implementation of 0.0.x (foundation) and 0.1.0 (first usable release). Tagged `v0.1.0` on 2026-09-15 as a historical
marker on its last commit, without a release build.
