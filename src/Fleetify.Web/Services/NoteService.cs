...
public sealed class NoteService
{
    ...
    public NoteService(IFleetifyDbContextFactory dbFactory, LicenseService licenses, TimeProvider time)
    {
    ...
    private async Task<string?> TierProblemAsync(FleetifyDbContext db, Endpoint endpoint, CancellationToken cancellationToken)
    {
