...
public static class ScriptChecks
{
    ...
    public static async Task<int> CountChecksAsync(FleetifyDbContext db, Guid scriptId, CancellationToken cancellationToken) =>
    ...
    /// </summary>
    public static async Task<string?> BindAsync(FleetifyDbContext db, Guid? checkClientId, Dictionary<string, string> parameters,
...
public sealed class ScriptService
{
    ...
    public ScriptService(IFleetifyDbContextFactory dbFactory, IServiceScopeFactory scopeFactory, TimeProvider time)
    {
