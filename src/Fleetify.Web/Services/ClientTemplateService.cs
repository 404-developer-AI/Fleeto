...
public sealed class ClientTemplateService
{
    ...
    public ClientTemplateService(IFleetifyDbContextFactory dbFactory, TimeProvider time, ILogger<ClientTemplateService> logger)
    {
    ...
    private static async Task<string?> ValidateAsync(FleetifyDbContext db, Guid? templateId, ClientTemplateInput input, CancellationToken cancellationToken)
    {
