...
public sealed class AuditQueryService
{
    ...
    public AuditQueryService(IFleetifyDbContextFactory dbFactory)
    {
    ...
    public static IReadOnlyList<string> KnownActions { get; } = typeof(Fleetify.Core.Interfaces.AuditActions)
