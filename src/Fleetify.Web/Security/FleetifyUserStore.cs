...
/// </list>
/// </summary>
public sealed class FleetifyUserStore : UserStore<ApplicationUser, ApplicationRole, FleetifyDbContext, Guid>
{
    ...
    public FleetifyUserStore(FleetifyDbContext context, ISecretProtector protector, IdentityErrorDescriber? describer = null)
