...
namespace Fleeto.Workers.Retention;
...
public sealed class RetentionService : WorkerLoop
{
    ...
    public RetentionService(IFleetoDbContextFactory dbFactory, SettingsStore settings, WorkerHeartbeat heartbeat, TimeProvider time,
