...
{
    return HeartbeatFile.Check(FleetoComponent.Workers);
}
...
builder.Services.AddFleetoInfrastructure(builder.Configuration, FleetoComponent.Workers);
builder.Services.AddFleetoWorkers(builder.Configuration);
