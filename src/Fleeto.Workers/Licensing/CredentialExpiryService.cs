...
namespace Fleeto.Workers.Licensing;
...
public sealed class CredentialExpiryService : WorkerLoop
{
    ...
    public CredentialExpiryService(IFleetoDbContextFactory dbFactory, SettingsStore settings, WorkerHeartbeat heartbeat, TimeProvider time,
