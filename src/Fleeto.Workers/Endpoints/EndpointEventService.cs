...
/// history only. Woken by <c>fleeto_endpoint_events</c>, polls every 30 seconds.
/// <para>
...
public sealed class EndpointEventService : WorkerLoop
{
    ...
    public EndpointEventService(IFleetoDbContextFactory dbFactory, INotificationBus bus, AlertNotificationService notifier,
