...
public sealed class SettingsService
{
    ...
    public SettingsService(IFleetoDbContextFactory dbFactory, SettingsStore settings, TimeProvider time)
    {
    ...
    internal static string? ValidateBackup(BackupInput input, string? effectiveSecret)
    {
        ...
        {
            return "The backup public key is not valid. Paste the public key printed by fleeto-tool backup keygen; it starts with fleeto-backup-pub:.";
        }
