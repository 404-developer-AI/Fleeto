...
public sealed class EndpointCheckService
{
    ...
    public EndpointCheckService(IFleetoDbContextFactory dbFactory, LicenseService licenses, INotificationBus bus, TimeProvider time,
    ...
    private async Task<(Endpoint? Endpoint, ServiceResult? Problem)> LoadManagedEndpointAsync(FleetoDbContext db, Guid endpointId,
    ...
    private static void Changed(FleetoDbContext db, Caller caller, Endpoint endpoint, DateTime now, object details)
    {
