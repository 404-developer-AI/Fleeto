...
public static class PublicApi
{
    ...
    public const string AddressRateLimitPolicy = "fleeto.api.address";

    private const string CallerItemKey = "fleeto-api-caller";
    ...
    public static IServiceCollection AddFleetoPublicApi(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    /// </summary>
    public static IApplicationBuilder UseFleetoPublicApiProblems(this IApplicationBuilder app) =>
    ...
    public static IEndpointRouteBuilder MapFleetoPublicApi(this IEndpointRouteBuilder app)
    {
    ...
    private static async ValueTask<object?> AuthenticateAndAuditAsync(EndpointFilterInvocationContext context, EndpointFilterDelegate next)
    {
        ...
        var logger = services.GetRequiredService<ILoggerFactory>().CreateLogger("Fleeto.Web.Api");
