...
namespace Fleeto.Gateway.Signing;
...
public enum SigningOutcomeState
{
    ...
    Refused,
    Failed,
    /// <summary>fleeto-signer did not finish the request in time. The row stays Pending.</summary>
    TimedOut
}
...
/// <summary>
/// Inserts a <see cref="SigningRequest"/> and waits for fleeto-signer to finish it (contract §4). The waiter is
