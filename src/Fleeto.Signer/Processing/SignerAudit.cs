...
{
    public const string ActorName = "fleeto-signer";

    public static async Task WriteAsync(FleetoDbContext db, AuditRecord record, DateTime now, CancellationToken cancellationToken)
    {
