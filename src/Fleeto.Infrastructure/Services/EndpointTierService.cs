...
public sealed class EndpointTierService
{
    ...
    internal const long LicenseAllocationLockKey = 0x466C656574696679; // "Fleeto"
    ...
    public EndpointTierService(IFleetoDbContextFactory dbFactory, LicenseService licenses, INotificationBus bus, TimeProvider time)
    {
