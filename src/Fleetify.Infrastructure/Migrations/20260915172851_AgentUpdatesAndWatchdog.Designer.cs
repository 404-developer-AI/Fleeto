...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.AgentCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.AgentRelease", b =>
                {
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Alert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.ApiKeyClient", b =>
                {
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.AuditEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.BackupRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.CertificateAuthority", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.CheckDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.CheckResult", b =>
                {
                    b.Property<DateTime>("Time")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.CheckState", b =>
                {
                    b.Property<Guid>("EndpointId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.ClientTemplateSite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.ClientTemplateSiteMonitoringTemplate", b =>
                {
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.ConfigChangeEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.DataKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.EndpointComponentState", b =>
                {
                    b.Property<Guid>("EndpointId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.EndpointConfig", b =>
                {
                    b.Property<Guid>("EndpointId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.EndpointEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.EndpointMonitoringTemplate", b =>
                {
                    b.Property<Guid>("EndpointId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.IngestBatch", b =>
                {
                    b.Property<Guid>("EndpointId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.InstanceSettings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.InstanceSigningKey", b =>
                {
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.InventorySnapshot", b =>
                {
                    b.Property<Guid>("EndpointId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.SetupToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.SigningRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.SitePolicy", b =>
                {
                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.WorkerWatermark", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Fleetify.Infrastructure.Identity.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Alert", b =>
                {
                    ...
                    b.HasOne("Fleetify.Core.Entities.Endpoint", "Endpoint")
                        .WithMany()
                        .HasForeignKey("EndpointId", "ClientId")
                        .HasPrincipalKey("Id", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.ApiKeyClient", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.ApiKey", null)
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.CheckDefinition", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.MonitoringTemplate", "MonitoringTemplate")
                        .WithMany("Checks")
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Client", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.ClientTemplate", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.ClientTemplateSiteMonitoringTemplate", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.ClientTemplateSite", null)
                        .WithMany("MonitoringTemplates")
                        .HasForeignKey("ClientTemplateSiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fleetify.Core.Entities.MonitoringTemplate", null)
                        .WithMany()
                        .HasForeignKey("MonitoringTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Endpoint", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.Site", "Site")
                        .WithMany("Endpoints")
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.InventorySnapshot", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.Endpoint", null)
                        .WithOne("Inventory")
                        .HasForeignKey("Fleetify.Core.Entities.InventorySnapshot", "EndpointId", "ClientId")
                        .HasPrincipalKey("Fleetify.Core.Entities.Endpoint", "Id", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.Site", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.Client", "Client")
                        .WithMany("Sites")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fleetify.Core.Entities.SitePolicy", b =>
                {
                    b.HasOne("Fleetify.Core.Entities.Policy", "Policy")
                        .WithMany()
                        .HasForeignKey("PolicyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Fleetify.Core.Entities.Site", null)
                        .WithOne("Policy")
                        .HasForeignKey("Fleetify.Core.Entities.SitePolicy", "SiteId", "ClientId")
                        .HasPrincipalKey("Fleetify.Core.Entities.Site", "Id", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Fleetify.Infrastructure.Identity.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Fleetify.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
