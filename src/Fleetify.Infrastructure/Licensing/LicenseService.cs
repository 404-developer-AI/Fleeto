...
public sealed class LicenseService
{
    ...
    public LicenseService(IFleetifyDbContextFactory dbFactory, TimeProvider time, ISecretProtector? protector = null, IAuditLog? audit = null)
    {
    ...
    /// </summary>
    public async Task<DateTime> ProtectedNowAsync(FleetifyDbContext db, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<LicenseStatus> GetStatusAsync(FleetifyDbContext db, CancellationToken cancellationToken = default)
    {
