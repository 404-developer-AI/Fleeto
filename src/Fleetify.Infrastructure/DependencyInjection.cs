...
namespace Fleetify.Infrastructure;
...
public static class DependencyInjection
{
    ...
    /// </summary>
    public static IServiceCollection AddFleetifyInfrastructure(this IServiceCollection services, IConfiguration configuration,
        FleetifyComponent component)
    {
        ...
        services.AddSingleton(sp => FleetifyDbContextFactory.BuildOptions(sp.GetRequiredService<NpgsqlDataSource>()));
        services.AddSingleton<IFleetifyDbContextFactory, FleetifyDbContextFactory>();
        ...
        services.AddSingleton(sp => new LicenseService(
            sp.GetRequiredService<IFleetifyDbContextFactory>(),
