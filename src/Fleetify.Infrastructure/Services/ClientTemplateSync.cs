...
{
    public static async Task ApplyAsync(FleetifyDbContext db, Client client, DateTime now, CancellationToken cancellationToken = default)
    {
    ...
    private static void AddChange(FleetifyDbContext db, Guid siteId, DateTime now) =>
