...
public static class ScriptCheckResolver
{
    ...
    public static readonly string AdminRole = FleetifyRoles.Admin.ToUpperInvariant();
    public static readonly string TechnicianRole = FleetifyRoles.Technician.ToUpperInvariant();

    public static async Task<ScriptCheckScript> ResolveAsync(FleetifyDbContext db, string? scriptIdText, Guid endpointClientId, string? osPlatform,
    ...
    /// </summary>
    public static async Task<bool> UserHasRoleAsync(FleetifyDbContext db, Guid userId, DateTime? lockedOutAt, CancellationToken cancellationToken,
