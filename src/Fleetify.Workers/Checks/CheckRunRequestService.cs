...
/// Woken by <c>fleetify_check_run_requests</c>, and polls every 30 seconds so a lost notification only delays work.
/// </summary>
public sealed class CheckRunRequestService : WorkerLoop
{
    ...
    public CheckRunRequestService(IFleetifyDbContextFactory dbFactory, INotificationBus bus, LicenseService licenses,
