...
namespace Fleetify.Workers.Webhooks;
...
/// Woken by <c>fleetify_outbox_webhooks</c>, polls every 30 seconds.
/// </para>
/// </summary>
public sealed class OutboxWebhookService : WorkerLoop
{
    ...
    public OutboxWebhookService(IFleetifyDbContextFactory dbFactory, INotificationBus bus, IWebhookSender sender, ISecretProtector protector,
    ...
    private async Task RecordFailureAsync(FleetifyDbContext db, OutboxWebhook delivery, WebhookDeliveryException failure, CircuitBreaker? breaker,
