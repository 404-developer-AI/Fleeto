...
public class WebFixtureBase : IAsyncLifetime
{
    ...
    public static Caller Technician() => CallerWith(Infrastructure.Data.SystemClientScope.Instance, FleetoRoles.Technician);

    public static Caller Admin() => CallerWith(Infrastructure.Data.SystemClientScope.Instance, FleetoRoles.Admin);
}
