...
/// <summary>
/// Stands in for fleetify-signer: polls pending signing requests and completes them with certificates from the test CA.
/// Only what the gateway tests need; the real rules live in fleetify-signer and its tests.
/// </summary>
