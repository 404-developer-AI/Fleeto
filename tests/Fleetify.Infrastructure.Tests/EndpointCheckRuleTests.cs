...
public class EndpointCheckRuleTests
{
    ...
    public async Task Each_role_can_run_its_own_statements_on_the_new_tables_with_the_real_grants()
    {
        ...
        await ExecuteAsync(connection, "SET LOCAL ROLE fleetify_web");
        ...
        await ExecuteAsync(connection, "RESET ROLE; SET LOCAL ROLE fleetify_workers");
        ...
        await ExecuteAsync(connection, "RESET ROLE; SET LOCAL ROLE fleetify_gateway");
