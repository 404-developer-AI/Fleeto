...
public sealed class AgentReleaseRuleTests
{
    private const string Manifest = """
        {"formatVersion":1,"version":"0.2.1","images":{"web":"sha256:0"},"agentBinaries":[
          {"component":"agent","platform":"windows","architecture":"amd64","file":"windows-amd64/fleetify-agent.exe","sha256":"9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08","size":10},
          {"component":"watchdog","platform":"linux","architecture":"arm64","file":"linux-arm64/fleetify-watchdog","sha256":"9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08","size":10}]}
        """;
    ...
    public void A_valid_manifest_lists_its_agent_binaries()
    {
        ...
        Assert.Contains(manifest.AgentBinaries, b => b.Component == AgentComponent.Watchdog && b.File == "linux-arm64/fleetify-watchdog");
    }

    [Theory]
    [InlineData("\"formatVersion\":1", "\"formatVersion\":2")]
    [InlineData("\"version\":\"0.2.1\"", "\"version\":\"latest\"")]
    [InlineData("windows-amd64/fleetify-agent.exe", "windows-amd64/../../evil.exe")]
    [InlineData("windows-amd64/fleetify-agent.exe", "linux-amd64/fleetify-agent")]
